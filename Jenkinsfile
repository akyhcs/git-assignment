...
stage('Tomcat Deployment'){
 deploy adapters: [tomcat8(credentialsId: 'tomcat01', path: '', url: 'http://fomop41962dns.eastus2.cloudapp.azure.com:8080/')], contextPath: 'petclinic', war: '01-Jenkins/petclinic-code/target/*.war'
}
